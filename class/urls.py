...
from .views import ClassListView, ClassCreateView, GroupDetailWithStudentsView, UserEnrolledClassView,  join_class, GroupDetailView, AllGroupsInClassView, GroupCreateView, join_group
